"""Regression checks for the atlas-model-slice-loom casebook."""
...
from casebook.harness import assert_expected, atlas_model_slice_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_model_slice_loom_summary(), assert_expected())
