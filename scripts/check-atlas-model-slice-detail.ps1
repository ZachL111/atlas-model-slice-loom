...
$repo = "atlas-model-slice-loom"
$language = "Haskell"
$category = "ML utilities"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/atlas-model-slice-walkthrough.md")) {
